...
\frame {
  \frametitle{Datadog}
   \begin{tikzpicture}[remember picture,overlay]
    \node[xshift=-1cm,yshift=-2cm] at (current page.north east) {\includegraphics[scale=.5]{imgs/datadog.jpg}};
\end{tikzpicture}
...
\frame {
  ...
  \begin{tikzpicture}[remember picture,overlay]
    \node[xshift=-1.1cm,yshift=-2cm] at (current page.north east) {\includegraphics[scale=.45]{imgs/logic.png}};
  \end{tikzpicture}
  \begin{alertblock}{Objetivo}
  \begin{itemize}
...
\frame {
  ...
  \begin{tikzpicture}[remember picture,overlay]
    \node[xshift=-1.5cm,yshift=-2cm] at (current page.north east) {\includegraphics[scale=.6]{imgs/appD.png}};
\end{tikzpicture}
  \begin{alertblock}{Objetivo}
  \begin{itemize}
...
\frame {
  \frametitle{NewRelic}
  \begin{tikzpicture}[remember picture,overlay]
    \node[xshift=-1.2cm,yshift=-2cm] at (current page.north east) {\includegraphics[scale=.5]{imgs/new.png}};
\end{tikzpicture}
  \begin{alertblock}{Objetivo}
  \begin{itemize}
...
\frame {
  \frametitle{Ganglia}
  \begin{tikzpicture}[remember picture,overlay]
    \node[xshift=-1.3cm,yshift=-2cm] at (current page.north east) {\includegraphics[scale=.4]{imgs/ganglia.jpg}};
\end{tikzpicture}
  \begin{alertblock}{Objetivo}
  \begin{itemize}
